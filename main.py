"""
TweetStitch - stitching your tweets into a story..
...
OAUTH_APP_SETTINGS = {
    ...
    'twitter': {
        ...
        'consumer_key': 'slesK09MgVWo8vmAKPsyw',
        'consumer_secret': 'xJCTJrhFZdLeUEbETqwdvuLZ4JkIvE6mCPkIscea3U',
...
HEADER = """
  <html><head><title>TweetStitch - stitching your tweets into a story..</title>
  </head><body>
  <h1>TweetStitch</h1>
  """
...
class MainHandler(RequestHandler):
    ...
    def get(self):
        ...
        followers = client.get('/statuses/followers')
        write('<h2>Followers (/statuses/followers)</h2>')
        write(followers)
        #for user in followers[0]:
	    #    write(user[1])
        
        public_status = client.get('/statuses/public_timeline')
        write('<h2>Public status (/statuses/public_timeline)</h2>')
        write(public_status)
